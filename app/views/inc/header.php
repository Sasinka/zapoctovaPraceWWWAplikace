...
if(!isset($_COOKIE[$cookie_name])) {
 // echo "Cookie named '" . $cookie_name . "' is not set!";
  ...
  $vypis = "http://localhost:4000/public/index.php?url=pages/post/".$_COOKIE[$cookie_name];
...
<div class="menu">
    ...
    <a href="http://localhost:4000/public/index.php?url=pages/index.php">Vítejte</a>
    <a href="http://localhost:4000/public/index.php?url=pages/about">O mě</a>
   <!--<a href="<script>localStorage.getItem('lastVisitedPage')</script>" >poslední</a>-->
    <a id="last-visited-link" href='<?php echo $vypis?>'>Poslední stránka</a>
</div>
